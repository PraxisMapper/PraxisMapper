        ...
        {           
            new StyleEntry() { MatchOrder = 1, Name ="Red",  StyleSet = "teamColor",
                PaintOperations = new List<StylePaint>() {
                    ...
                    new StylePaint() { HtmlColorCode = "FF0000", FillOrStroke = "stroke", FixedWidth=5, LinePattern= "solid", LayerId = 30 }
                },
            ...
            new StyleEntry() { MatchOrder = 2, Name ="Green",   StyleSet = "teamColor",
                PaintOperations = new List<StylePaint>() {
                    ...
                    new StylePaint() { HtmlColorCode = "00FF00", FillOrStroke = "stroke", FixedWidth=5, LinePattern= "solid", LayerId = 30 }
                },
                StyleMatchRules = new List<StyleMatchRule>() {
            ...
            new StyleEntry() { MatchOrder = 3, Name ="Blue",  StyleSet = "teamColor",
                PaintOperations = new List<StylePaint>() {
                    ...
                    new StylePaint() { HtmlColorCode = "0000FF", FillOrStroke = "stroke", FixedWidth = 5, LinePattern= "solid", LayerId = 30 }
                },
                StyleMatchRules = new List<StyleMatchRule>() {
            ...
            new StyleEntry() { MatchOrder = 4, Name ="White",  StyleSet = "teamColor",
                PaintOperations = new List<StylePaint>() {
                    ...
                    new StylePaint() { HtmlColorCode = "ffffff", FillOrStroke = "stroke", FixedWidth=5, LinePattern= "solid", LayerId = 30 }
                },
                StyleMatchRules = new List<StyleMatchRule>() {
            ...
            new StyleEntry() { MatchOrder = 5, Name ="Orange",   StyleSet = "teamColor",
                PaintOperations = new List<StylePaint>() {
                    ...
                    new StylePaint() { HtmlColorCode = "ff4f00", FillOrStroke = "stroke", FixedWidth = 5, LinePattern= "solid", LayerId = 30 }
                },
                StyleMatchRules = new List<StyleMatchRule>() {
            ...
            new StyleEntry() { MatchOrder = 6, Name ="Teal",  StyleSet = "teamColor",
                PaintOperations = new List<StylePaint>() {
                    ...
                    new StylePaint() { HtmlColorCode = "53fee3", FillOrStroke = "stroke", FixedWidth=5, LinePattern= "solid", LayerId = 30 }
                },
                StyleMatchRules = new List<StyleMatchRule>() {
            ...
            new StyleEntry() { MatchOrder = 7, Name ="Yellow",  StyleSet = "teamColor",
                PaintOperations = new List<StylePaint>() {
                    ...
                    new StylePaint() { HtmlColorCode = "fbff00", FillOrStroke = "stroke", FixedWidth = 5, LinePattern= "solid", LayerId = 30 }
                },
                StyleMatchRules = new List<StyleMatchRule>() {
            ...
            new StyleEntry() { MatchOrder = 8, Name ="Pink",  StyleSet = "teamColor",
                PaintOperations = new List<StylePaint>() {
                    ...
                    new StylePaint() { HtmlColorCode = "f8a4fc", FillOrStroke = "stroke", FixedWidth=5, LinePattern= "solid", LayerId = 30 }
                },
                StyleMatchRules = new List<StyleMatchRule>() {
            ...
            new StyleEntry() { MatchOrder = 9, Name ="outline",  StyleSet = "teamColor", //May be used more often explicitly assigned.
                PaintOperations = new List<StylePaint>() {
                    new StylePaint() { HtmlColorCode = "000000", FillOrStroke = "stroke", FixedWidth=5, LinePattern= "solid", LayerId = 29 },
                },
                StyleMatchRules = new List<StyleMatchRule>() {
