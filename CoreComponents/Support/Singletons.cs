...
namespace CoreComponents
{
    public static class Singletons
    {
        ...
        public static List<TagParserEntry> defaultTagParserEntries = new List<TagParserEntry>()
        {
            ...
            new TagParserEntry() { id = 12, name ="admin", HtmlColorCode = "00FF2020",FillOrStroke = "stroke", LineWidth=1, LinePattern= "solid", TagParserMatchRules = new List<TagParserMatchRule>() { new TagParserMatchRule() { Key = "boundary", Value = "administrative", MatchType = "equals" }} }, //We got rid of these for a reason, don't bring htem back. These are transparent.
