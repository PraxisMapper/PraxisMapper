...
namespace PraxisCore.Support
{
    ...
    public record StoredOsmElementForJson(long id, string name, long sourceItemID, int sourceItemType, string elementGeometry, string WayTags, bool IsGameElement, bool isUserProvided, bool isGenerated, long? version);
